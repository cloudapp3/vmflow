...
private report. Do not open a public issue for an unpatched vulnerability.

Include the affected version and platform, reproduction steps or a proof of
concept, the expected impact, and any suggested mitigation. Do not include
production credentials, private keys, or unrelated personal data.

The maintainers will acknowledge the report, validate its scope, and coordinate
a fix and disclosure timeline with the reporter. Please allow a reasonable
