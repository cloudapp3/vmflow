...
vmflow includes the following Go modules in its distributed binary. Their
license texts are included under `third_party_licenses/` in source and release
archives.
...
and the corresponding license copies whenever release dependencies change.
